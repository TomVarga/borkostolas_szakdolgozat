...
Ezen szakdolgozat keretében elsõ sorban a feladatom a CoHITS algoritmus implementálás volt, mely mellé csatlakozott néhány Borkóstolás projekt\cite{Borkóstolás projekt} keretében használt már Szilárd Iván által implementált algoritmus, mint a Hamming, Koszinusz, Precedencia, Összefüggõségi, Pozíció szerinti.
