...
Most, hogy tisztában vagyunk a felhasznált technológiákkal rá térhetünk azok konkrét használatának példáira. A $php-login$ könyvtár csomag két fõ osztályt definiál. 
...
\begin{itemize}
	...
	\begin{itemize}
		\item A nem üres beviteli mezõ továbbá nem lehet se túl nagy, tehát kisebbnek kell lennie mint 99999.999
		\item Maximum 3 decimális jegy pontosság engedélyezett	
	\end{itemize}
\end{itemize}
...
Az így elõkészített adatsorok feldolgozását a $getData$ JavaScript függvény folytatja, melynek feladata több AJAX híváson keresztül a számítások elvégzése, majd a kinyert adatok alapján a grafikon rajzoló függvények meghívása. Az elsõ AJAX hívás a \newline$selectAlgorithm.php$ állományra irányul, mely feladata a munka kétfelé ágaztatása az alapján, hogy melyik típusú algoritmus lett kiválasztva a demó oldalon. A két kategória egyszerûen az alapján van meghatározva, hogy ki implementálta az adott algoritmust. Az általam implementált $CoHITS$ algoritmus képzi az egyik csoportot, mely a \newline $HITSstart.php$ állományból indul ki, míg a kapott kód alapján mûködõ többi algoritmus kezelésért a $calculateGivenAlgorithm.php$ felelõs.
