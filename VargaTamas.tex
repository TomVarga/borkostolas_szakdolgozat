...
Viszont az kétségtelen, hogy használatának elõnyei túlnyomó részben vannak hátrányaihoz képest.


Számomra mint már korábban említettem a CSS fõ elõnye az volt, hogy a web alkalmazás stilisztikai felépítést egy fájlból könnyedén tudtam módosítani.
...
\todo nyelvrõl általában
\todo adatbázis elérés
