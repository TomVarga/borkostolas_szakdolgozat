...
\url{http://bor.tvarga.hu}

Az android alkalmazás letölthetõ bármelyik fent említett URL -rõl a jobb oldali floating menün keresztül, vagy az alábbi közvetlen linken:
\hyperref[borkostolas.apk]{http://bor.tvarga.hu/borkostolas.apk}
