...
\section{Android}
Egy Android alkalmazás mûködésének megértéséhez az alábbi fogalmakkal és forrásokkal okvetlenül tisztában kell lennünk:
...
Egy activity-nak a mûködését úgy a legegyszerûbb megérteni, ha megnézzük milyen életciklussal rendelkezik. Fontos azt észben tartani, hogy minden fõbb életciklus lépéshez létezik egy callback metódis mely segítségével az adott életciklushoz illõ mûveleteket végezhetünk el.
