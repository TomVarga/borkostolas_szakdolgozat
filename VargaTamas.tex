...
\begin{minipage}{\linewidth}
	\begin{lstlisting}[language=php,label={lst:include jquery}, caption={AJAX példa kódrészlet}]
...
A Google Charts egy grafikonokat vizualizáló eszköz, amit leggyakrabban $JavaScript$-tel szoktunk használni. Elõször be kell tölteni a Google Chart könyvtárat és a hozzá szükséges AJAX API-t mint az a \ref{lst:init google charts} kódrészletben is látható.
...
\bibitem{ECMAScript 5.1 release} http://www.ecma-international.org/publications/files/ECMA-ST/Ecma-262.pdf

\bibitem{deep linking for ajax}http://blog.onthewings.net/2009/04/08/deep-linking-for-ajax/
