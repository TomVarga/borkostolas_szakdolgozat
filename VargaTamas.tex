...
\begin{itemize}
	...
	\item {Plugin API}: A Sublime Text rendelkezik egy nagy erejû Python alapú plugin API-val ami lehetõvé teszi a környezet további kiváló szolgáltatásokkal való bõvítését, mint például linterekkel vagy automatikus fájl feltöltõ eszközökkel.
\end{itemize}
