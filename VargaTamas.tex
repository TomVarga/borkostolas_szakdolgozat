...
Miután sikeresen frissült az adatbázis a felhasználó új értékelésével el kell hogy készítsük az algoritmusok számára azt a mátrixot amely azon értékeléseket tartalmazza melyek majd a számítás futtatandó. Az adatbázisból a többi értékelés begyûjtésért a $getTastersScores.php$ segéd állomány felelõs, mely azt egy JSON stringben adja vissza az AJAX hívásnak.
