...
\section{Grafikonok}
Az igényes megjelenítés megkövetelt valamilyen típusú grafikonkezelést. Mivel több nagyon könnyen és jól mûködõ $JavaScript$ publikus könyvtár létezik már ennek a feladatnak az ellátására, úgy gondoltam, hogy egy-kettõt kipróbálok mielõtt véglegesen valamelyik használata mellett döntenék. Kis kutató munka után arra jutottam, hogy a választásom a $Google Charts$\cite{Google Charts homepage} és a $Charts.js$\cite{Charts.js homepage} két API közül az egyikre fog esni.
...
\begin{table}[h!]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Példa a Google Chart által megjelenítendõ adatok szerkezetére \label{tbl:google charts data table}}
\end{table}
